...
<div class="content-wrapper">
  ...
  <div class="card">
      <div class="row">
        <div class="col-10">
          <h5 class="card-header mb-3">Laporan Penjualan Reseller</h5>
        </div>
        <div class="col-2 py-3 flex-end">
          <a type="button" href="<?=base_url('laporan_cs/r_laporan_add')?>" class="btn btn-primary"><span><i class='bx bx-bookmark-plus'></i></span> Tambah Data</a>
        </div>
    ...
    <thead>
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td><?php echo ucwords($row['jumlah_product']); ?> Items</td>
            <td>Rp. <?php echo ucwords($row['harga_product']); ?></td>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" class="btn btn-primary" type="button" href="<?php echo site_url('laporan_cs/r_laporan_edit/'.$row['id_laporan']); ?>">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-center">
                        ...
                        <p>Laporan <strong><?php echo $row['nama_reseller']?></strong> ?</p>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                          Close
                        </button>
                        <a type="button" href="<?php echo site_url('laporan_cs/r_laporan_del/'.$row['id_laporan']); ?>" class="btn btn-primary">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
