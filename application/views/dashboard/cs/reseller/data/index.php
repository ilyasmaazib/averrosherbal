...
<div class="content-wrapper">
  ...
  <div class="card">
      <div class="row">
        <div class="col-10">
          <h5 class="card-header mb-3">Data Penjualan Reseller</h5>
        </div>
        <div class="col-2 py-3 flex-end">
          <a type="button" href="<?=base_url('laporan_cs/r_data_add')?>" class="btn btn-primary"><span><i class='bx bx-bookmark-plus'></i></span> Tambah Data</a>
        </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" class="btn btn-primary" type="button" href="<?php echo site_url('laporan_cs/r_data_edit/'.$row['id_data']); ?>">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a type="button" href="<?php echo site_url('laporan_cs/r_data_del/'.$row['id_data']); ?>" class="btn btn-primary">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
