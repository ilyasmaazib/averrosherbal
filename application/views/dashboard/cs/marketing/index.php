...
<div class="content-wrapper">
  ...
  <!-- Hoverable Table rows -->
    <div class="card px-5">
      <div class="row">
        <div class="col-12">
          <h5 class="card-header mb-3">Daftar | Marketing Sales</h5>
        </div>
    ...
    <thead>
        ...
        <tbody class="table-border-bottom-0">
          ...
          foreach ($sales as $key => $row)
          {
            ?>
          <tr>
            <td><?php echo ucwords($row['id_sales']); ?></td>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?php echo site_url('laporan_cs/m_edit/'.$row['id_sales']); ?>">
                    <i class="bx bx-edit-alt me-1"></i> Edit</a>
                  <a class="dropdown-item" class="btn btn-primary" data-bs-toggle="modal" style="cursor: pointer;" data-bs-target="#del<?php echo $row['id_sales']; ?>">
                    <i class="bx bx-trash me-1"></i> Delete</a>
                </div>
                <!-- Delete -->
                <div class="modal fade" id="del<?php echo $row['id_sales']; ?>" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalCenterTitle">Hapus Sales</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body text-center">
                        <h5>Apakah anda yakin ingin menghapus</h5>
                        <p>sales <strong><?php echo $row['nama_sales']?></strong> ?</p>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                          Close
                        </button>
                        <a type="button" href="<?php echo site_url('laporan_cs/m_del/'.$row['id_sales']); ?>" class="btn btn-primary">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tambah /</span> Markeeting Sales</h4>

    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <h5 class="card-header">Profile Marketing Sales</h5>
          <!-- Account -->
          <form action="<?=site_url('laporan_cs/m_add_process')?>" method ="POST" enctype="multipart/form-data">
          <div class="card-body">
              <div class="row">
                <div class="mb-3 col-md-6">
                  <label for="firstName" class="form-label">Nama Sales</label>
                  <small class="text-primary"> * Tulis dengan huruf besar</small>
                  <input class="form-control" name="nama_sales" type="text" id="firstName" required autofocus />
                </div>
                <div class="mb-3 col-md-6">
